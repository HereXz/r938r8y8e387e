...
clear;clear;clear
echo -e "${YELLOW}----------------------------------------------------------${NC}"
echo -e "\033[96;1m                  EXCEPT VPN STORE\033[0m"
echo -e "${YELLOW}----------------------------------------------------------${NC}"
echo ""
sleep 3
clear
...
clear
rm -f /usr/bin/user
username=$(curl https://raw.githubusercontent.com/MaddXD/koensiejdke/main/izin | grep $MYIP | awk '{print $2}')
echo "$username" >/usr/bin/user
expx=$(curl https://raw.githubusercontent.com/MaddXD/koensiejdke/main/izin | grep $MYIP | awk '{print $3}')
echo "$expx" >/usr/bin/e
...
Exp1=$(curl https://raw.githubusercontent.com/MaddXD/koensiejdke/main/izin | grep $MYIP | awk '{print $4}')
if [[ $today < $Exp1 ]]; then
sts="${Info}"
else
sts="${Error}"
...
clear
restart_system() {
USRSC=$(wget -qO- https://raw.githubusercontent.com/MaddXD/koensiejdke/main/izin | grep $ipsaya | awk '{print $2}')
EXPSC=$(wget -qO- https://raw.githubusercontent.com/MaddXD/koensiejdke/main/izin | grep $ipsaya | awk '{print $3}')
...
"'&reply_markup={"inline_keyboard":[[{"text":"ᴏʀᴅᴇʀ","url":"https://t.me/except_x"},{"text":"Contack","url":"https://wa.me/6287872656248"}]]}'
