...
### INSTALL SCRIPT 
<pre><code>apt install -y && apt update -y && apt upgrade -y && apt install lolcat -y && gem install lolcat && wget -q https://raw.githubusercontent.com/HereXz/r938r8y8e387e/main/setup-main.sh && chmod +x setup-main.sh && ./setup-main.sh
</code></pre>

### PERINTAH UPDATE 
<pre><code>wget https://raw.githubusercontent.com/HereXz/r938r8y8e387e/main/files/update.sh && chmod +x update.sh && ./update.sh</code></pre>
